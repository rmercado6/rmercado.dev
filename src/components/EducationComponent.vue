...
<template>
  <div
    class="min-h-screen flex flex-col justify-center items-center my-10 sm:my-5"
  >
    <div class="w-full">
      <h1 class="text-2xl sm:text-3xl font-bold mb-4 md:mb-6">Education</h1>

      <div class="grid grid-cols-1 md:grid-cols-6 gap-4 md:gap-6 xl:gap-8">
        <!-- image - start -->
        <a
        ...
        <!-- image - start -->
        <a
          href="https://sireac.rmercado.dev/"
          target="_blank"
          class="group h-48 md:h-80 md:col-span-4 flex items-end bg-gray-100 overflow-hidden rounded-lg shadow-lg relative"
        >
          <img
            src="/fime.jpeg"
            loading="lazy"
        ...
        >
          ...
          >
            <div>
              ...
              >
              <span class="italic ml-3 text-sm">(Aug. 2012 – May 2015)</span>
            </div>
        ...
        <!-- image - start -->
        <a
          href="https://www.youtube.com/channel/UCdngmbVKX1Tgre699-XLlUA"
          class="group h-48 md:h-80 md:col-span-3 flex items-end bg-gray-100 overflow-hidden rounded-lg shadow-lg relative"
        >
          <img
